...
def write_file(working_directory, file_path, content):
    ...
    if not abs_file_path.startswith(abs_working_dir):
        return f'Error: Cannot read content "{file_path}" as {abs_file_path} it is outside the permitted working directory'
    ...
    try:
        ...
        return f'Failed to write to file path: {file_path}, {e}'
